...
dashboardPage(
    ...
    dashboardSidebar(
      ...
      sidebarMenu(
        ...
        menuItem("Demographics", icon = icon("circle"), tabName = "tab3", 
                 badgeLabel = "statline",
                 badgeColor = "red"),
        #I am still trying to figure out how to "hide" the subitems under item
        #Instead of showing them all at once 
        #We would have to write our own CSS or HTML to solve this problem!
                    menuSubItem("Population size & density", icon = icon("people-arrows"),
                                tabName = "subitem1"),
                    menuSubItem("Age", icon = icon("birthday-cake"),
                                tabName = "subitem2"),
                    menuSubItem("Gender", icon = icon("venus-mars"),
                                tabName = "subitem3"),
                    menuSubItem("Life expectancy", icon = icon("heartbeat"), 
                                tabName = "subitem4"),
                    menuSubItem("Mortality & birth rate", icon = icon("cross"),
                                tabName = "subitem5"),
                    menuSubItem("Educationan", icon = icon("user-graduate"),
                                tabName = "subitem6"),
                    menuSubItem("Income", icon = icon("money-check"),
                                tabName = "subitem7"),
                    menuSubItem("Unemployment", icon = icon("laptop-house"),
                                tabName = "subitem8"),
        menuItem("Economic trends", icon = icon("circle"), tabName = "tab4", badgeLabel = "statline",
                 badgeColor = "red"),
